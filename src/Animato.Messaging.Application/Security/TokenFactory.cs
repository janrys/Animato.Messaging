...
public class TokenFactory : ITokenFactory
{
    ...
    public string GenerateAccessToken(User user, Application application, params ApplicationRole[] roles)
    {
        ...
        var claims = new List<Claim>(claimFactory.GenerateClaims(user, AuthorizationMethod.Unknown, roles))
        {
    ...
    public string GenerateIdToken(User user, Application application, params ApplicationRole[] roles)
    {
        ...
        {
            new Claim("login", user.Login),
            new Claim(JwtRegisteredClaimNames.AuthTime, dateTime.UtcNowOffset.ToUnixTimeSeconds().ToString(GlobalOptions.Culture)),
        };
